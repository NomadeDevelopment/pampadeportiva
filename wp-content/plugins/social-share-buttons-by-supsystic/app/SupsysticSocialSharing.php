...
class SupsysticSocialSharing
{
    ...
    public function __construct()
    {
        ...
        $environment = new Rsc_Environment($pluginName, '1.8.1', $pluginPath);
    ...
    public function installUpdate() {
        ...
        if(get_option($this->environment->getPluginName().'_updated') < 320) {
            $this->twitterFollowUpdate();
        }
    }
    ...
    public function twitterFollowUpdate() {
        global $wpdb;
        $prefix = $wpdb->prefix . $this->environment
                ->getConfig()
                ->get('db_prefix');
        $twitter_follow = dirname(__FILE__) . '/configs/twitter_follow.sql';
        $sql = str_replace('%prefix%', $prefix, file_get_contents($twitter_follow));
